...
import { AppRadioGroup } from "../../atoms/AppRadioGroup";
...
const BookingModal = ({
  ...
  const handleBookingModeSelect = (nextMode: BookingMode) => {
    ...
    if (nextMode === "projectDiscussion") {
      updateForm("inspection", "no");
    }
  };
              ...
              <>
                ...
                <div className="mb-8">
                  ...
                  <p
                    ...
                    "
                  >
                    Start with the kind of electrical help you need, then add
                    your details below.
                  </p>
                </div>
                  ...
                  <>
                    ...
                    <section>
                      <SectionHeader
                        ...
                        description={
                          isProjectDiscussion
                            ? "Tell us about your new home or wiring project"
                      ...
                      <div className="space-y-4">
                        <AppRadioGroup
                          ...
                          options={[
                            {
                              value: "electrician",
                              label: "General electrical service",
                            },
                            {
                              value: "projectDiscussion",
                              label: "New Home / Full Wiring",
                            },
                          ]}
                          onChange={(event) =>
                            handleBookingModeSelect(
                              event.target.value as BookingMode,
                            )
                          }
                        />
                        ...
                        {isProjectDiscussion && (
                          <AppTextarea
                            ...
                            placeholder="Add the project scope, timing or any useful details"
                            rows={4}
                          />
                        )}
